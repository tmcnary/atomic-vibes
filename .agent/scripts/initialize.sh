...
echo ""
echo "Atomic Vibes has been installed!"
echo ""
echo "To complete setup, you need to:"
echo ""
echo -e "1. ${YELLOW}Fill in project-specific details:${NC}"
...
echo ""
echo -e "2. ${YELLOW}Or use an LLM to auto-fill (recommended):${NC}"
echo "   Run this in Claude Code or similar:"
echo ""
echo -e "   ${GREEN}I need you to analyze this codebase and set up"
echo "   Atomic Vibes. Please:"
...
echo ""
echo -e "3. ${YELLOW}Run the boot-up script:${NC}"
echo "   ./atomic boot-up"
echo ""
